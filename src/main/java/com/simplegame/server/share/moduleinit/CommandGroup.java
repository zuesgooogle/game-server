...
public class CommandGroup {
	...
	public static String getCmdModule(String command) {
		return (String) cmdModuleMap.get(command);
	}

	public static Integer getCmdDest(String command) {
		return (Integer) cmdDestMap.get(command);
	}

	public static boolean isIoModule(String command) {
